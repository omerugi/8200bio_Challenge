...
class DecisionTreeTrainer:
    ...
    def preprocess_data(self, data):
       ...
       'is_color_condition_white', 'shape', 'gender',
       'is_primary_locations_arm', 'is_texture_exfoliation',
       'is_texture_not_sure', 'is_primary_locations_head', 'is_texture_dry',
       'is_secondary_locations_neck', 'is_color_condition_normal',
       'is_primary_locations_back', 'vesicle', 'is_primary_locations_chest',
       'pain.is_pain', 'is_texture_cracks',
       'is_secondary_locations_upper_arm_internal',
       'is_secondary_locations_foot_external', 'is_secondary_locations_toes',
       'is_color_condition_black', 'is_secondary_locations_nose',
       'is_secondary_locations_cheeks', 'is_color_condition_purple',
       'is_secondary_locations_shin_external',
       'is_secondary_locations_abdomen',
       'is_secondary_locations_upper_arm_external',
       'is_secondary_locations_fingers', 'is_texture_wet',
       'is_secondary_locations_knee', 'is_secondary_locations_navel',
       'is_secondary_locations_forehead', 'crater',
       'is_secondary_locations_perioral', 'is_color_condition_blue',
       'lossOfHair.type', 'is_primary_locations_groin_area',
       'is_secondary_locations_ear', 'is_nailsdiseases_onychomycosis',
       'is_secondary_locations_thigh_external', 'is_secondary_locations_chin',
       'is_secondary_locations_buttock', 'is_secondary_locations_eye',
       'is_secondary_locations_elbow_pit', 'is_secondary_locations_scrotum',
       'is_nailsdiseases_pitting', 'is_secondary_locations_kneepit',
       'is_secondary_locations_back',
       'is_nailsdiseases_koilonychia__spooning_',
       'is_secondary_locations_eyelid', 'is_secondary_locations_chest',
       'is_secondary_locations_hand_internal', 'is_secondary_locations_penis',
       'is_secondary_locations_scalp', 'is_secondary_locations_thigh_internal',
       'is_secondary_locations_wrist_internal', 'pus',
       'is_nailsdiseases_onycholysis', 'bleeding', 'temperature',
       'duration.from_birth', 'is_texture_rough', 'is_texture_smooth',
